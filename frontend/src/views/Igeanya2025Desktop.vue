<template>
      ...
      <div class="w-1/2 border-r border-black overflow-scroll">
        ...
        <div class="mt-4">
          ...
          <div class="border-b border-black pb-8">
            <img src="https://blog.kakaocdn.net/dn/cjprU5/btsNi3IVkz9/K6TwmJd2YcIBbypbP3IzS0/img.png" alt="" class="w-[50%] m-auto">
          ...
          <div class="border-b border-black py-2 text-center">
            <a href="https://tmm.im/p/44730" target="_blank" class="no-underline text-lg">선입금 / 통판 폼 (TMM) 4.20 22:00 ~ 5.9 12:00 →</a>
          </div>
          <!-- 책 정보 -->
          ...
          <div class="space-y-2 px-10 mb-8">
            ...
            <p class="text-base leading-7">SCOOP의 새로운 기획으로 여배우 배이현과 얽힌 사이비 종교 ‘영명교’의 취재를 이어가던 승연과 세일. 그러던 어느 날, 승연은 싸늘한 주검으로 돌아온다. 경찰은 자살이라 단정하지만, 세일은 수사에 석연치 않은 점을 느낀다. 이에 세일은 규혁과 함께 승연의 죽음에 얽힌 비밀을 파헤치기 시작한다. <br>그러나 파고들수록, 자신이 알지 못했던 승연의 또 다른 얼굴과 마주하게 되고, 세일은 진실에서 점점 더 멀어지는 느낌에 사로잡히는데…</p>
          </div>
        </div>
      </div>
  ...
  const posts = ref([
    ...
    { title: '점화', number: '07', path: './writing/bestar/19.md' }
  ]);
